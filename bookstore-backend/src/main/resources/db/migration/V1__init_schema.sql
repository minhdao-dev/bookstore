...
(
    ...
    status       VARCHAR(20)    NOT NULL CHECK (status IN ('PENDING_PAYMENT', 'PAID', 'CANCELLED', 'COMPLETED')),
...
(
    ...
    fulfillment_status VARCHAR(20)    NOT NULL DEFAULT 'PENDING'
        CHECK (fulfillment_status IN ('PENDING', 'GRANTED', 'PACKING', 'SHIPPED', 'DELIVERED', 'RETURNED', 'CANCELLED'))
);
